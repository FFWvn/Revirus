    ...
    <header class="header" id="header" role="banner">
      <div class="row">
        <div class="logo-header">
          <a href="/" title="Revirus" rel="home" class="header__logo" id="logo">
            <img src="logo.png" alt="Revirus" class="header__logo-image">
          </a>
        </div>
        ...
        <div class="header__region region region-header">
          <nav class="navigation" id="navigation">
            <ul class="menu">
              <li class="menu__item is-leaf first leaf"><a href="#" title="" class="menu__link">Om revirus</a></li>
              <li class="menu__item is-leaf leaf"><a href="#" title="" class="menu__link">kurser</a></li>
              <li class="menu__item is-leaf leaf"><a href="#" title="" class="menu__link">medlemmer</a></li>
              <li  class="menu__item is-leaf last leaf"><a href="#" title="" class="menu__link">kontakt</a></li>
            </ul>
          </nav>

          <div class="block block-banner-header">
            <img src="images-template/revMand-lille.png" alt="banner">
          </div>
        </div>
      </div>
    </header>
